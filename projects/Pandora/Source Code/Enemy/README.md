...
敵キャラクターの行動を管理するシステム。ここでは最も基本的な敵キャラクター「スライム(Slime)」のコードを紹介する。

<img src="../../Images/PinkSlim_Walking1.png" width="200">
...
| ファイル | 説明 |
|---------|------|
| EnvironmentContext.cs | 敵キャラクターの周辺環境情報を統合する。これを参照すれば接地状態や壁に触れているかなどが分かる。(環境情報を取得するDetectorコードは[Player/README.md](../Player/README.md)を参照)|
